...
parser.add_argument('--n1', type=int, default=3, help='Matrix order(nxn)')
parser.add_argument('--n2', type=int, default=3, help='Matrix order(nxn)')
...
def main():
    ...
    if (args.sparsity):
        ...
        flatA = flatA.reshape(n1, n1)
        flatB = flatB.reshape(n2, n2)
        # print(flatA)
